...
class TextDataset(Dataset):
    def __init__(self, tokenizer: PreTrainedTokenizer, args, file_path: str, block_size=512):
        ...
        if os.path.exists(cached_features_file) and not args.overwrite_cache:
            ...
            # Note that we are loosing the last truncated example here for the sake of simplicity (no ing)
...
def train(args, train_dataset, model: PreTrainedModel, tokenizer: PreTrainedTokenizer) -> Tuple[int, float]:
    ...
    train_dataloader = DataLoader(
        train_dataset, sampler=train_sampler, num_workers=int(args.num_workers), batch_size=args.train_batch_size, pin_memory=True
    )
